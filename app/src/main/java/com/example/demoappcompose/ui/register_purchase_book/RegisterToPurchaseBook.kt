                ...
                when (getBooksState) {
                    ...
                    is UiState.Success -> {
                        ...
                        Box(
                            ...
                            var selectedBook by remember { mutableStateOf(bookList[0]) }
                            ...
                            Column(
                                ...
                                CustomTextField(modifier = Modifier
                                    .fillMaxWidth(),
                                    text = selectedBook.discount.toString(),
                            ...
                            when (uiState) {
                                ...
                                is UiState.UnAuthorised -> {
                                    LaunchedEffect(Unit) {
                                        val errorMessage = (uiState as UiState.UnAuthorised).errorMessage
                                        context.toast(message = errorMessage)
                                        navController.navigate(Screens.LoginScreen.route) {
                                            popUpToTop(navController)
                                        }
