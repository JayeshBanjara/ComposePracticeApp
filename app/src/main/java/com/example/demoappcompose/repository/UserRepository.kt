...
class UserRepository @Inject constructor(
    ...
    suspend fun getPaperHistory(
        headerMap: Map<String, String>, request: CommonRequest
    ...
    suspend fun updateProfile(
        headerMap: Map<String, String>, request: UpdateProfileRequest
    ): ProfileResponse {
        return apiRequest {
    ...
    suspend fun registerToPurchaseBook(
        headerMap: Map<String, String>, request: PurchaseBookRequest
    ): SuccessResponse {
        return apiRequest {
    ...
    suspend fun getHeadingList(
        headerMap: Map<String, String>, request: HeadingListRequest
    ): HeadingListResponse {
        return apiRequest {
    ...
    suspend fun generaTePaymentRequest(
        headerMap: Map<String, String>, request: GeneratePaymentRequest
    ): SuccessResponse {
        return apiRequest {
            apiInterface.generaTePaymentRequest(
                headerMap = headerMap, request = request
            )
        }
    }
    ...
    suspend fun getQuestionList(
        headerMap: Map<String, String>, request: QuestionListRequest
    ): QuestionListResponse {
        return apiRequest {
            apiInterface.getQuestionList(
                headerMap = headerMap, request = request
            )
        }
    }
    ...
    suspend fun approveRejectPayment(
        headerMap: Map<String, String>, request: PaymentApproveRejectRequest
